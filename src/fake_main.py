...
def main(args):
    ...
    if args.task == 'graph':
        ...
        if args.model != 'handcraft':
            raise ValueError("Only 'handcraft' model is supported for node classification.")
    ...
    if args.plot:
        ...
        plt.tight_layout()
        plot_path = f"plot_{args.model}_{args.dataset.lower()}_{args.epochs}epochs_lr{args.lr}_{args.gamma}over{args.step_size}.png"
